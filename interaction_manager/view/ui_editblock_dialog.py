...
class Ui_EditBlockDialog(object):
    ...
    def retranslateUi(self, EditBlockDialog):
        ...
        self.moduleInteractionGroupBox.setTitle(_translate("EditBlockDialog", "Interaction module(s)"))
        self.moduleRandomizeRadioButton.setText(_translate("EditBlockDialog", "Randomize"))
        self.moduleFileNameLineEdit.setPlaceholderText(_translate("EditBlockDialog", "Select File"))
        self.moduleFolderNameLineEdit.setPlaceholderText(_translate("EditBlockDialog", "Select Folder"))
        self.moduleFileRadioButton.setText(_translate("EditBlockDialog", "File Name"))
        self.moduleSelectFolderToolButton.setText(_translate("EditBlockDialog", "..."))
        self.moduleSelectFileToolButton.setText(_translate("EditBlockDialog", "..."))
